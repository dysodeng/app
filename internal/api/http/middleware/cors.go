...
func CrossDomain(ctx *gin.Context) {
	...
	if origin != "" {
		...
		ctx.Header("Access-Control-Expose-Headers", "Content-Length,Access-Control-Allow-Origin,Access-Control-Allow-Headers,Cache-Control,Content-Language,Content-Type,Expires,Last-Modified,Pragma,Platform-Type,Trace-Id,Span-Id")
