...
func (c *userServiceClient) Info(ctx context.Context, in *UserInfoRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (UnimplementedUserServiceServer) Info(context.Context, *UserInfoRequest) (*UserResponse, error) {
